...
import { state as player_state, source, setSource } from "./Player";
...
export default function Controls(props: {
	...
	const state = () => {
		return source() === props.src ? player_state() : "stopped";
	};
	...
	return (
		<button
			...
			title={props.title}
			class={`rounded-full border my-1 py-2 px-4 flex items-center ${
				{
					error: "bg-red-100 text-red-800 border-red-800",
					playing: "bg-green-100 text-green-800 border-green-800",
					loading: "bg-blue-100 text-blue-800 border-blue-800",
					stopped:
