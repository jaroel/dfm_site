  ...
  view! {
    ...
    >
      ...
      {move || match controls_state() {
          ControlsState::Stopped => {
              view! {
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-play inline" viewBox="0 0 16 16">
          ...
          ControlsState::Error | ControlsState::Playing => {
              view! {
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-stop-circle inline" viewBox="0 0 16 16">
          ...
          ControlsState::Loading => {
              view! {
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-hourglass-split inline" viewBox="0 0 16 16">
