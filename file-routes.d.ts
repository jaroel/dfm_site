...
declare module "virtual:file-routes" {
  ...
  const routes: readonly [
    ...
    },
    {
      path: "/uzg/(uzg)";
      page: true;
      $component: FileRouteLazyRef<typeof import("./src/routes/uzg/(uzg)")>;
      $$route: FileRouteEagerRef<typeof import("./src/routes/uzg/(uzg)")>;
    },
    {
      path: "/uzg/:file_name";
      page: false;
      $GET: FileRouteLazyRef<typeof import("./src/routes/uzg/[file_name]")>;
      $HEAD: FileRouteLazyRef<typeof import("./src/routes/uzg/[file_name]")>;
      $$route?: undefined;
    }
  ];
