        ...
        <button
            ...
            on:click=move |_| {
                match controls_state() {
                    ControlsState::Loading | ControlsState::Playing | ControlsState::Error => {
                        audio_src.set("".to_string())
                    }
                    ControlsState::Stopped => audio_src.set(local_src.get()),
                };
            }
